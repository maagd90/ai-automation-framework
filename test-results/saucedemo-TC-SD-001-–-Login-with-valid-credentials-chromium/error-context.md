...
- Name: saucedemo.spec.ts >> TC_SD_001 – Login with valid credentials
- Location: generated/tests/saucedemo.spec.ts:22:1
...
> 23  |   await page.goto(URL);
  ...
  111 |   await expect(page.locator('#login-button')).toBeVisible();
  112 | });
  113 | 
```